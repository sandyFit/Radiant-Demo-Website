        ...
        >
            <div className="flex justify-between">
                <div className="flex items-center gap-10">
                    ...
                    <h2 className='text-indigo-50 text-5xl font-[900] tracking-wider z-30'>
                        {service.title}
                    </h2>
                </div>
                <span className='text-indigo-50 text-5xl font-[900] '>{`0${index + 1}.`}</span>
            </div>
            
            <div className="grid grid-cols-[repeat(12, minmax(5rem, 1fr))] grid-rows-[repeat(10, minmax(5rem, 1fr))]
                gap-2 mt-8">
                <figure className='col-span-4 col-start-1 col-end-5 row-span-5 h-[30rem] relative  
                bg-indigo-300 rounded-[20px] overflow-hidden  '>
                    <img src={service.imgSrc} alt={service.title} className="w-full h-full object-cover" />
                </figure>

                <article className={`col-span-6 col-start-6 h-[30rem] text-indigo-200 font-[400] rounded-[20px] p-10
