            ...
            <div className="flex flex-col xl-sm:flex-row justify-center items-center xl-sm:items-start 
                ...
                <article className="grid grid-cols-1 xl-2xl:gap-4 2xl-lg:gap-6">
                    <div className="w-[85vw] h-[15.4rem] base:w-[80vw] base:h-[18rem] lg-sm:h-[14rem] lg-xl:h-[12rem]
                        ...
                        2xl-lg:w-[38rem] 2xl:w-[40rem] 2xl-xl:w-[44rem] 
                        ...
                        <span className="hidden xl-md:block text-[10rem] 2xl:text-[12rem] absolute 
                            xl-md:bottom-[12.8rem] xl:bottom-[10.6rem] xl-2xl:bottom-[7.8rem] 2xl-sm:bottom-[7rem] 
                            2xl:bottom-[4.5rem] xl-md:left-6 2xl:left-16">
                            ”
                        </span>
                        <p className="text-p2 mt-6 xl-md:mt-[4.2rem] xl-xl:mt-[8rem] xl:mt-[6.6rem] 
                            xl-2xl:mt-[5rem] 2xl-sm:mt-[6.4rem] 2xl:mt-[6.6rem] px-3">
                            {renderDescription(review)}
                        </p>
                    </div>

                    <div className='hidden xl-2xl:flex w-[16rem] 2xl-sm:w-[18.8rem] 2xl:w-[20rem] 
                        2xl-xl:w-[23.4rem] h-16 
                        2xl-lg:h-20 glass justify-center items-center rounded-[10px] 2xl-xl:rounded-xl'>
                        <span className='flex text-indigo-500' ref={starsRef}>
                            {[...Array(5)].map((_, index) => (
                                <HiStar key={index}
                                    aria-label="Star rating"
                                    className="star text-[2.8rem] 2xl-lg:text-[3.2rem] 2xl-xl:text-[3.6rem]" />
                            ))}
                        </span>
                    </div>
                </article>
