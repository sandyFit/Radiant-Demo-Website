    ...
    return (
        <section className='flex justify-center items-center w-full relative'>
            <div className="flex flex-col xl-sm:flex-row justify-center items-center xl-sm:items-start 
                ...
                <article className="grid grid-cols-1 place-items-center gap-2 md:gap-3 2xl:gap-6">
                    <div className='w-[85vw] h-[85vw] base:w-[80vw] base:h-[80vw] xl-sm:w-[20.8rem] 
                        xl-sm:h-[20.8rem] xl-md:w-[22rem] xl-md:h-[22rem] 2xl:w-[20.8rem] 
                        2xl:h-[20.8rem] rounded-xl bg-indigo-600 shadow-lg overflow-hidden'>
                        <img
                            ref={imgRef}
                            src={srcImg}
                    ...
                    <div className='hidden xl-sm:flex 2xl:hidden w-[20.8rem] xl-md:w-[22rem] h-12 glass 
                ...
                <article className="grid grid-cols-1 gap-6">
                    <div className="w-[85vw] h-[15.4rem] base:w-[80vw] base:h-[18rem] lg-sm:h-[14rem] lg-xl:h-[12rem]
                        ...
                        xl:h-[25.28rem] xl-xl:w-[27.2rem]   2xl:w-[44rem] 
                        2xl:h-[20.8rem] bg-indigo-600 relative hover:bg-indigo-700 rounded-[10px] 2xl:rounded-xl
                        text-indigo-200 px-4 2xl:px-16 shadow-lg ">
                        <span className="hidden xl-md:block text-[10rem] 2xl:text-[12rem] absolute 
                            xl-md:bottom-[12.8rem] xl:bottom-[10.6rem] 2xl:bottom-[4rem]
                            xl-md:left-6 2xl:left-16">
                            ”
                        </span>
                        <p className="text-p2 mt-6 xl-md:mt-[4.2rem] xl-xl:mt-[8rem] xl:mt-[6.6rem] px-3">
                            {renderDescription(review)}
                        </p>
                    </div>

                    <div className='hidden 2xl:flex w-[23.4rem] h-20 glass justify-center items-center rounded-xl'>
                        <span className='flex text-indigo-500' ref={starsRef}>
                            {[...Array(5)].map((_, index) => (
                                <HiStar key={index}
