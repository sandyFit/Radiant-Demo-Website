        ...
        <div className='flex justify-center items-center w-full relative'>
            <div className="relative flex justify-center items-center w-full">
                <div className="absolute xl-sm:right-[4.6rem] xl-md:right-20 xl:right-[5.4rem] 
                    ...
                    2xl-lg:right-[8.8rem] 3xl:right-[14.2rem] -bottom-6 lg-sm:-bottom-[2.2rem] 
                    ...
                    <button aria-label='Next'
                        className='w-28 md:w-40 base:w-48 lg-sm:w-56 lg:w-60 lg-xl:w-64 xl-sm:w-36 xl:w-[10.9rem]
                            xl-xl:w-[13.2rem] xl-2xl:w-[6.74rem] xl-3xl:w-[7.72rem] 2xl-sm:w-[7.88rem] 2xl-lg:w-[8.1rem]
                            3xl:w-[8.88rem] h-10 lg-sm:h-12 lg-xl:h-16 xl-sm:h-12 
