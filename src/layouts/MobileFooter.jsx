...
const MobileFooter = () => {
    return (
        <article className="flex flex-col justify-center items-center bg-indigo-900 w-full mt-5 md:mt-10 
            ...
            <div className='w-full flex bg-indigo-950 flex-col lg:flex-row justify-center lg:justify-between 
                items-center py-3'>
                <div className="flex justify-evenly text-min-white list-none w-[76%] md:w-[60%] lg-sm:w-[45%] lg:w-1/2">
                    <a href='#'
