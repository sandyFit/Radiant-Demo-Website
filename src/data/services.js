const services =[
    ...
    {       
        ...
        categories: [
            ...
            {
                name: "Extractions",
                description: "Before removing any teeth your dentist will discuss all replacement options with you. \nWe will also discuss any temporary replacement for the missing tooth before a more definitive option is placed."
            },
            {
                name: "Children Dentistry",
                description: "Our team have all been trained in child behavioural management techniques and are very good at acclimatising your child to the dental environment and making your child comfortable in the dental chair."
            }
        ]
    },
    {
